...
void main() {
  ...
  do {
    ...
    try {
      var calPeso = double.parse(peso ?? "0");
      var calAltura = double.parse(altura ?? "0");
      var pessoa = Pessoa(nome, calPeso, calAltura);
      print("Olá, ${pessoa.getNome()}, sua classificação é ");
      print(calc_imc.calculoDoImc(calPeso, calAltura));
    } catch (e) {
      print(e);
      exit(0);
    }
